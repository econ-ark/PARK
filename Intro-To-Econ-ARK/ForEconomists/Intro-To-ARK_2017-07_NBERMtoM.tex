...
\NBERMtoMYN{\end{comment}}{}

\begin{frame}\frametitle{Goals}

  Make it {\it much} easier:   \pause 
  \bi
\item To get started doing structural HA modeling
...
\begin{center}
\includegraphics[width=3in]{/Volumes/Data/Code/ARK/PARKive/pri/PARK-make/Intro-To-ARK/Figures/Retail-Sales-Collapse.jpg}
\end{center}
