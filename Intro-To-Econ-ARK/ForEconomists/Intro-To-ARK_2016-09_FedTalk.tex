...
\providecommand{\CDC}{\texttt{CDC}} % Christopher D Carroll
\providecommand{\NMP}{\texttt{NMP}} % Nathan M Palmer
\providecommand{\MNW}{\texttt{MNW}} % Matthew N White
\providecommand{\DCL}{\texttt{DCL}} % David C Low
\providecommand{\JXY}{\texttt{JXY}} % Jiaxiong X Yao
\providecommand{\ABK}{\texttt{ABK}} % Alex B Kaufman
...
\\ \hline {\it Alex Kaufman} & \texttt{{\ABK}} & CFPB $\rightarrow$ ? (Alcatraz?)  %& \href{mailto:alexander.kaufman@cfpb.gov}{No Fixed Address; Expected: Alcatraz}
