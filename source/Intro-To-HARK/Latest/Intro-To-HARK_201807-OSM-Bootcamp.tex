\message{ !name(Intro-To-HARK.tex)}% 20180729: Version for CDC presentation at OSM (boolean:OSMCDC)
% 20180521: Version for presentation at ECB 
% 20180330: Version for presentation at GMU after Jackie presents MESA 
% !TeX spellcheck = en_GB

% The Intro-To-HARK-make.sh script that makes PrintMe and ViewMe versions requires the two alternative documentclass lines to be exactly as below
% DO NOT MODIFY THE FOLLOWING TWO LINES EXCEPT TO SWITCH THEIR COMMENTING STATUS (change which begins with a percent sign) 
\documentclass[public]{beamer}\beamerdefaultoverlayspecification{<+->}
...
\provideboolean{Goethe}
\setboolean{Goethe}{true}
% \setboolean{Goethe}{false}
\providecommand{\GoetheYN}{\ifthenelse{\boolean{Goethe}}}
...
\provideboolean{OSMCDC}
\setboolean{OSMCDC}{true}
%\setboolean{OSMCDC}{false}
\providecommand{\OSMCDCYN}{\ifthenelse{\boolean{OSMCDC}}}
...
\providecommand{\OSMCDCHideEnd}{  \ifthenelse{\boolean{OSMCDC}}{\setboolean{includeTF}{true}}{}}
...
\OSMCDCYN{
  \author{Chris Carroll, Matt White}
  \date{``Hands-On Heterogeneous Agent Macroeconomics'' \\ Minicourse at Open Source Macro Bootcamp, Chicago \\ July-August 2018}
}{}
...
\message{ !name(Intro-To-HARK.tex) !offset(-3) }
...
% \OSMCDCHideBegin\ifInclude{}{}\OSMCDCHideEnd
...
\end{document}
\message{ !name(Intro-To-HARK.tex) !offset(-1428) }
